...
namespace Istıhdam
{
    public partial class Musteriprofil : System.Web.UI.Page
    {
        ...
        {
            int uyeid = Convert.ToInt32(Session["musteriid"]);
        ...
        protected void guncellebtn_Click(object sender, EventArgs e)
        {
            ...
            {
                int sayi = new Musterilerdao().uyeguncelle(musteriadsoyadtxt.Text, musteriemailtxt.Text, musteriteltxt.Text, Convert.ToByte(musterisehirdrop.SelectedItem.Value), musteridogtartxt.Text, musteriadrestxt.Text, musterikuladitxt.Text, musterisifretxt.Text, Convert.ToInt32(Session["musteriid"]));
