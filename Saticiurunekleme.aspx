<%@ Page Title="" Language="C#" MasterPageFile="~/Satici.Master" AutoEventWireup="true" CodeBehind="Saticiurunekleme.aspx.cs" Inherits="Istıhdam.Saticiurunekleme" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="margin: 50px auto auto auto; padding: 50px; width: 80%; text-align: center; height: 401px;border-style:solid">
        ...
        <tr>
            ...
            <td style="text-align: left; width: 364px;">
                <asp:DropDownList ID="kategoridrop" runat="server" OnSelectedIndexChanged="kategoridrop_SelectedIndexChanged" AutoPostBack="True">
        ...
        <tr>
            <td colspan="2" style="text-align: center">
                <asp:Button ID="Button1" runat="server" CssClass="btn-success" Text="Ürünü Kaydet" OnClick="Button1_Click" />
