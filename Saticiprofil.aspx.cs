...
namespace Istıhdam
{
    public partial class Saticiprofil : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            int uyeid = Convert.ToInt32(Session["saticiid"]);
        ...
        protected void guncellebtn_Click(object sender, EventArgs e)
        {
            ...
            {
                int sayi = new Saticilardao().uyeguncelle(saticiadtxt.Text,saticisoyadtxt.Text,saticikuladitxt.Text,saticisifretxt.Text,saticiemailtxt.Text,saticiteltxt.Text,saticiadrestxt.Text,Convert.ToByte(saticisehirdrop.SelectedItem.Value),saticidogtartxt.Text,Convert.ToInt32(Session["saticiid"]));
